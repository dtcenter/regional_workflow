...
#-----------------------------------------------------------------------
#
# This file defines a function that sets various field name parameters
# needed when performing verification.  The way these parameters are set
# depends on the field being verified (which is an input to this function).
#
...
#-----------------------------------------------------------------------
#
function set_vx_fieldname_params() {
#
#-----------------------------------------------------------------------
#
