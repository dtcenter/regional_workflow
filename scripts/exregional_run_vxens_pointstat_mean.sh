...
OUTPUT_DIR="${OUTPUT_BASE}/metprd/point_stat_mean"
STAGING_DIR="${OUTPUT_BASE}/stage/${FIELDNAME_IN_MET_FILEDIR_NAMES}_mean"
LOG_SUFFIX="_${FIELDNAME_IN_MET_FILEDIR_NAMES}_mean_${CDATE}"
#
#-----------------------------------------------------------------------
#
...
The list of forecast hours for which to run METplus is empty:
  ...
  metplus_config_fp="${METPLUS_CONF}/PointStat_${FIELDNAME_IN_MET_FILEDIR_NAMES}_mean.conf"
