...
mkdir_vrfy -p "${OUTPUT_BASE}/${CDATE}/metprd_vxold/point_stat_prob"  # Output directory for point_stat tool.
#
#-----------------------------------------------------------------------
#
...
metplus_config_fp="${METPLUS_CONF}/vxold/PointStat_conus_sfc_prob.conf"
...
metplus_config_fp="${METPLUS_CONF}/vxold/PointStat_upper_air_prob.conf"
${METPLUS_PATH}/ush/run_metplus.py \
  -c ${METPLUS_CONF}/common.conf \
  -c ${metplus_config_fp} || \
print_err_msg_exit "
