...
#-----------------------------------------------------------------------
#
mkdir_vrfy -p "${OUTPUT_BASE}/${CDATE}/metprd_vxold/grid_stat_mean"  # Output directory for GridStat tool.
#
#-----------------------------------------------------------------------
#
...
metplus_config_fp="${METPLUS_CONF}/vxold/GridStat_${FIELDNAME_IN_MET_FILEDIR_NAMES}_mean.conf"
