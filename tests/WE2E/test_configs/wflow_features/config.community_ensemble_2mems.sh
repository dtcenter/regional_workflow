...
# (NUM_ENS_MEMBERS) set to "2".  The lack of leading zeros in this "2"
# should cause the ensemble members to be named "mem1" and "mem2"
# (instead of, for instance, "mem01" and "mem02").
#
